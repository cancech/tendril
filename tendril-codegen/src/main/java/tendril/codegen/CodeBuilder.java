...
public class CodeBuilder {
     ...
     * CTOR
     * 
     * @param initialLines {@link String}... lines that the builder should start
     */
    public CodeBuilder(String... initialLines) {
    ...
    /**
     * Decrease the indentation by one level, with subsequent lines being brought in by one "tab". Cannot deindent beyond the start of the line.
     */
