...
public interface Annotatable {
     ...
     * 
     * @param data {@link JAnnotation} with the details of the annotation applied to the element
     */
    void addAnnotation(JAnnotation data);

    /**
     * Get all annotations applied to the element
     * 
     * @return {@link List} of {@link JAnnotation} instances applied to the element
     */
