 ...
 */
package tendril.test.helper.assertions;
...
public class TendrilAssert {
    ...
    /**
     * Assertion to verify that two {@link ClassType} instances are the same
     * 
     * @param expected {@link ClassType} that is expected
     * @param actual   {@link ClassType} that was actually generated by the code under test
     */
    public static void assertEquals(ClassType expected, ClassType actual) {
        assertImportData(expected.getPackageName(), expected.getClassName(), actual);
    }

    /**
     * Assertion to verify that the {@link ClassType} is as expected
     * 
     * @param expected {@link Class} the class the import data is expected to reflect
     * @param actual   {@link ClassType} to verify
     */
    public static void assertImportData(Class<?> expected, ClassType actual) {
     ...
     * @param actual       {@link ClassType} to verify
     */
    public static void assertImportData(String expectedPkg, String expectedName, ClassType actual) {
