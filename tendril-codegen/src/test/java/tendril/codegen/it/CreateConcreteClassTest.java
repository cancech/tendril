...
public class CreateConcreteClassTest {
    ...
    public void testCreateClassWithFields() {
        ...
        matcher.eq("");
        matcher.eq("    private " + VisibilityType.class.getName() + " enumField = " + VisibilityType.class.getName() + ".PACKAGE_PRIVATE;");
        matcher.eq("");
        matcher.eq("}");
        matcher.match(cls.generateCode());
    }
    ...
    public void testCreateClassWithParent() {
        ...
        matcher.eq("");
        matcher.regex("@" + Generated.class.getName() + "\\(.+\\)");
        matcher.eq("protected class B extends q.w.e.r.t.Y {");
        matcher.eq("");
        matcher.eq("}");
        matcher.match(cls.generateCode());
    }
    ...
    public void testCreateClassWithInterface() {
        ...
        matcher.eq("");
        matcher.regex("@" + Generated.class.getName() + "\\(.+\\)");
        matcher.eq("protected class B implements q.w.e.r.t.Y {");
        matcher.eq("");
        matcher.eq("}");
        matcher.match(cls.generateCode());
    }
    ...
    public void testCreateSimpleGeneric() {
        ...
        matcher.eq("");
        matcher.eq("    <U extends a.B> void abc123(T t, U u, " + List.class.getName() + "<? super z.x.c.V> list) {");
        matcher.eq("    }");
        matcher.eq("");
        matcher.eq("}");
    ...
    public void testCreateComplexClass() {
        ...
        matcher.eq("@" + Deprecated.class.getName() + "(forRemoval = true, since = \"yesterday\")");
        matcher.eq("@" + TestMultiAttrsAnnotation.class.getName() + "(valInt = 789, valStr = \"qwerty\")");
        matcher.eq("protected class B extends q.w.e.r.t.Y implements q.w.e.r.t.Y, a.b.c.d.F {");
        matcher.eq("");
        matcher.eq("    public boolean booleanField = false;");
        matcher.eq("");
        matcher.eq("    private " + VisibilityType.class.getName() + " enumField = " + VisibilityType.class.getName() + ".PACKAGE_PRIVATE;");
        ...
        matcher.eq("    }");
        matcher.eq("");
        matcher.eq("    protected <U extends a.B> B(" + String.class.getName() + " strParam, U u) {");
        matcher.eq("        a");
        matcher.eq("        b");
        matcher.eq("        c");
        matcher.eq("        d");
        ...
        matcher.eq("    }");
        matcher.eq("");
        matcher.eq("    <T, U extends a.B> void abc123(T t, U u, " + List.class.getName() + "<? super z.x.c.V> list) {");
        matcher.eq("    }");
        matcher.eq("");
        matcher.eq("}");
        matcher.match(cls.generateCode());
