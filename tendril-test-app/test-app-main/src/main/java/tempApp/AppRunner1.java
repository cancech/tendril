...
public class AppRunner1 implements TendrilRunner {
    public static String expectedMessage = "must be set by main";
    public static Class<?> expectedRunner;
    ...
    public void run() {
        timesRun++;
        assertion(expectedRunner == getClass(), "Runner expected to be " + expectedRunner + " but was " + getClass());

        System.out.println("RUNNING APP RUNNER 1!!!");
