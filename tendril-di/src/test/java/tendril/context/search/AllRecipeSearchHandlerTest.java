...
/**
 * Test case for the {@link AllRecipeSearchHandler}
 */
public class AllRecipeSearchHandlerTest extends AbstractUnitTest {
	...
	// Instance to test
	private AllRecipeSearchHandler<Object> handler;
	...
	protected void prepareTest() {
		handler = new AllRecipeSearchHandler<>();
	}
	...
	public void testNoResults() {
		...
		Assertions.assertEquals("All", result.getType());
	...
	public void testPrimaryandBasicResults() {
		...
		Assertions.assertEquals("All", result.getType());
		CollectionAssert.assertEquals(Arrays.asList(mockRecipe1, mockRecipe2, mockRecipe3, mockRecipe4, mockRecipe5, mockRecipe6), result.getRecipes());
	}
