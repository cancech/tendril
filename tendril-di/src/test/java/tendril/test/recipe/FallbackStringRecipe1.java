...
public class FallbackStringRecipe1 extends AbstractRecipe<String, String> {

    /** The value that the recipe produces */
    public static final String VALUE = "FallbackString1";
     ...
     */
    public FallbackStringRecipe1(Engine engine) {
