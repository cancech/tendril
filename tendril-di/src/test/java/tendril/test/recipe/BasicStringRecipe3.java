...
public class BasicStringRecipe3 extends AbstractRecipe<String, String> {

    /** The value that the recipe produces */
    public static final String VALUE = "BasicString3";
     ...
     */
    public BasicStringRecipe3(Engine engine) {
