...
public class PrimaryStringRecipe2 extends AbstractRecipe<String, String> {

    /** The value that the recipe produces */
    public static final String VALUE = "PrimaryString2";
     ...
     */
    public PrimaryStringRecipe2(Engine engine) {
