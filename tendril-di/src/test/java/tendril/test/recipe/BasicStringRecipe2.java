...
public class BasicStringRecipe2 extends AbstractRecipe<String, String> {

    /** The value that the recipe produces */
    public static final String VALUE = "BasicString2";
     ...
     */
    public BasicStringRecipe2(Engine engine) {
